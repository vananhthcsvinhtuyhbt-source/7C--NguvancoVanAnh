...
export const firebaseConfig = customConfig || {
  apiKey: getEnv("VITE_FIREBASE_API_KEY", "AIzaSy_SO_LIEN_LAC_LOP_7C_FIREBASE_API_KEY"),
  authDomain: getEnv("VITE_FIREBASE_AUTH_DOMAIN", "so-lien-lac-7c.firebaseapp.com"),
  projectId: getEnv("VITE_FIREBASE_PROJECT_ID", "so-lien-lac-7c"),
  storageBucket: getEnv("VITE_FIREBASE_STORAGE_BUCKET", "so-lien-lac-7c.appspot.com"),
  messagingSenderId: getEnv("VITE_FIREBASE_MESSAGING_SENDER_ID", "373721379714"),
  appId: getEnv("VITE_FIREBASE_APP_ID", "1:373721379714:web:so-lien-lac-7c-web-app"),
